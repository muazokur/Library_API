...
public class AuthorsController : BaseController
{
    ...
    [HttpDelete("{id}")]
    public async Task<ActionResult<DeletedAuthorResponse>> Delete([FromRoute] Guid id)
    {
    ...
    [HttpGet("{id}")]
    public async Task<ActionResult<GetByIdAuthorResponse>> GetById([FromRoute] Guid id)
    {
    ...
    [HttpGet]
    public async Task<ActionResult<GetListResponse<GetListAuthorListItemDto>>> GetList([FromQuery] PageRequest pageRequest)
    {
